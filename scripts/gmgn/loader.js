try {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.querySelectorAll("a.bookmarklet").forEach(abtns => {
            const msg = "Please go to the GMGN website and activate the tool. The tool will not work unless you are on the GMGN website"
            const hyperliquidUrl = "https://gmgn.ai";
